...
from ikwen_kakocase.kakocase.views import list_available_companies, DeliveryOptionList, DeployCloud,\
    add_delivery_company_to_local_database, Go, SuccessfulDeployment, CustomerJourney, ChangeDeliveryOption
...
urlpatterns = patterns(
    ...
    url(r'^deliveryOptions/$', permission_required('accesscontrol.sudo')(DeliveryOptionList.as_view()), name='deliveryoption_list'),
    url(r'^changeDeliveryOption/$', permission_required('accesscontrol.sudo')(ChangeDeliveryOption.as_view()), name='change_deliveryoption'),
    url(r'^changeDeliveryOption/(?P<object_id>[-\w]+)$', permission_required('accesscontrol.sudo')(ChangeDeliveryOption.as_view()), name='change_deliveryoption'),
