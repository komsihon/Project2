...
urlpatterns = patterns(
    ...
    url(r'^product/(?P<object_id>[-\w]+)/$', permission_required('kako.ik_manage_product')(ChangeProduct.as_view()),
        name='change_product'),
    ...
    url(r'^category/(?P<object_id>[-\w]+)/$', permission_required('kako.ik_manage_product')(ChangeCategory.as_view()),
        name='change_category'),
