...
urlpatterns = patterns(
    ...
    url(r'^promocodes/$', permission_required('commarketing.ik_manage_marketing') (PromoCodeList.as_view()), name='promo_code_list'),
    url(r'^change_promotion/$', permission_required('commarketing.ik_manage_marketing') (ChangePromotion.as_view()), name='change_promotion'),
    url(r'^change_promotion/(?P<promotion_id>[-\w]+)/$', permission_required('commarketing.ik_manage_marketing') (ChangePromotion.as_view()), name='change_promotion'),
    url(r'^change_promo_code/$', permission_required('commarketing.ik_manage_marketing')(ChangePromoCode.as_view()), name='change_promo_code'),
    url(r'^change_promo_code/(?P<promo_code_id>[-\w]+)/$', permission_required('commarketing.ik_manage_marketing')(ChangePromoCode.as_view()), name='change_promo_code'),
